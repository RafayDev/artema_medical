<footer class="text-center space-up">
      <img src="{{url('/')}}/images/grey-logo.png" class="img-fluid ">
        ...
        <p>© Copy Rights 2019 Artema Group of Companies </p>
        <p>All Rights Reserved. <a href="#">Design By Artema</a></p>
        <a href="#" class="fa fa-facebook social-ico" style="font-size: 30px"></a>
        <a href="#" class="fa fa-instagram social-ico" style="font-size: 30px"></a>       
